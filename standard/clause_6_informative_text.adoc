...
The concept of broadcasting is defined in the Python Numpy library https://numpy.org/devdocs/user/theory.broadcasting.html, from where some of these images and descriptions are sourced.
