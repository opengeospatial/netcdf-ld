...
image::bald-ont-1.png[Figure 4. BALD vocabulary]
...
The concept of broadcasting defined in the Python Numpy library https://numpy.org/devdocs/user/basics.broadcasting.html, from where Figures 8-11 and the associated descriptions are sourced.
